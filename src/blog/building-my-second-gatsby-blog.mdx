...
Secret is out! I built this blog with [Gatsby](https://gatsbyjs.org) and damnnnn Gatsby is dope! I knew since my first time using Gatsby that it was dope, but the feeling is on a whole new level this time. Although I hate doing one thing twice except for some good reason. I initially wanted [Next.js](https://vercel.org), but then I thought if I wanted to get up to speed, I'd better used Gatsby.
