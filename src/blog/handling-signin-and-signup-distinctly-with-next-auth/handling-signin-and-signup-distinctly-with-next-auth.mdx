...
date: 2023-10-22T12:24:00.000Z
last-modified: 2023-10-22T12:25:00.000Z
...
const authorize = async (credentials: SignInCredentials, _req: any) => {
    ...
    providers: [
      ...
      CredentialsProvider({
        ...
        async authorize(credentials: SignInCredentials | undefined, req) {
          ...
          return await authorize(credentials, req)
        },
      }),
    ],
    callbacks: {
